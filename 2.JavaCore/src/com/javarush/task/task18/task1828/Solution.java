...
public class Solution {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<com.javarush.task.task18.task1828.Solution.Product> products = new ArrayList<>();

        try (BufferedReader fileReader = new BufferedReader(new FileReader(fileName))) {
            while (fileReader.ready()) {
                com.javarush.task.task18.task1828.Solution.Product product = getProduct(fileReader.readLine());
        ...
        switch (args[0]) {
            ...
            case "-d": {
                int id = Integer.parseInt(args[1]);
                com.javarush.task.task18.task1828.Solution.Product productToDelete = null;
                for (com.javarush.task.task18.task1828.Solution.Product product : products) {
    ...
    public static com.javarush.task.task18.task1828.Solution.Product getProduct(String string) {
        ...
        return new com.javarush.task.task18.task1828.Solution.Product(Integer.parseInt(id), name, price, quantity);
    }
}
